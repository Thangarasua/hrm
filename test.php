			...
			<div class="col-xl-4 theiaStickySidebar">
				<div class="card card-bg-1">
					<div class="card-body p-0">
						<span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2 position-relative" data-bs-toggle="dropdown">
							<img src="<?php echo $personalInfo && !empty($personalInfo['profilePhoto']) ? './uploads/employee_documents/profile_photo/' . $personalInfo['profilePhoto'] : './assets/img/users/sample-user.jpg'; ?>" class="w-auto h-auto" alt="Img" id="cropedImage">
							<i class="fas fa-camera position-absolute" style="right: -2px;bottom: -1px;color: black;font-size: 15px;padding: 5px;background: #ffff;border-radius: 14px;"></i>
						</span>
						<div class="d-flex justify-content-center">
							<div class="dropdown-menu" id="profileDropdown">
								...
								<div class="dropdown-item pointer">
									...
									<input type="file" id="fileInput" class="item-img" accept="image/*" style="display: none;">
...
<script>
	...
	//   $("#fileInput").click(); // Triggers file input click
	// });

	$('#openFile').on('click', function() {
		$('#fileInput').click(); // ✅ Trigger file input from a different element
	});
	...
	$('#cropImageBtn').on('click', function(ev) {
		$uploadCrop.croppie('result', {
			...
			size: {
				width: 800, // Increase this for better quality
